...
<html lang="en">
  ...
  <body>
	...
	<div class="form-signin">
		<?php if( isset($success) ) { echo '<font color="red">Account Created Successfully</font>'; }?>
		<h2 class="form-signin-heading">SDFCU - Sign in</h2>
		<?php $attributes = array('class'=>'form-signin', 'name'=>'login'); ?>
		<?php echo form_open('user/login',$attributes); ?>
			<div class="input-block-level">
				<?php $username = array('name'=>'username','id'=>'password','placeholder'=>'Username'); ?>
			...
			<?php $attributes = array('class'=>'btn btn-primary','name'=>'submit','value'=>'Sign In'); ?>
			<?php echo form_submit($attributes); ?>

			<?php echo form_fieldset_close(); ?>
		<?php echo form_close(); ?>
		</br>
		<a href="<?php echo site_url('/register'); ?>">Register for new account</a>
	</div>
    </div> <!-- /container -->
